...
RF1SNR = zeros(432,length(targChans),length(names));
RF2SNR = zeros(432,length(targChans),length(names));
GF1SNR = zeros(432,length(targChans),length(names));
GF2SNR = zeros(432,length(targChans),length(names));
