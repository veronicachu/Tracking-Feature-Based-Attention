...
RF1SNR = zeros(108,length(targChans),length(names));
RF2SNR = zeros(108,length(targChans),length(names));
GF1SNR = zeros(108,length(targChans),length(names));
GF2SNR = zeros(108,length(targChans),length(names));
...
line([18.5 18.5],[0 14],'LineStyle',':','Color','k')
line([19 19],[0 14],'LineStyle',':','Color','k')
ylabel('SNR')
